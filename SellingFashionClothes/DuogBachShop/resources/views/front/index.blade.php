...
@section('title', 'DuogBachDev Shop')
@section('body')
<!-- Hero Section Begin -->
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-blog">
                    ...
                    <div class="latest-text">
                        ...
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minus quis alias, recusandae
                            laborum molestiae error? Sed odio quas consequuntur in id veniam laborum! Debitis
                            delectus, aspernatur consequatur porro placeat est.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
